	...
	\begin{columns}[t]
		...
		\begin{column}{.25\linewidth}
			\begin{block}{\center Intervallestimering}
				\center\normalsize Konfidensintervall for $\mu$ (KI)\\
				{\footnotesize\raggedright
				...
				\center\normalsize Konfidensintervall for $\sigma^2$ med $n-1$ (KI)\\
				{\footnotesize\raggedright
				...
				\center\normalsize Konfidensintervall for $p$\\
				{\footnotesize\raggedright
					...
					Erstatt $p$ i utrykket med $\hat p$ for å kunne rekne ut
				}
				\center\normalsize Konfidensintervall for $\mu_1 - \mu_2$\\
				{\footnotesize\raggedright
					...
					$\mu_1-\mu_2=(\bar x_1 - \bar x_2) \pm x_\frac{\alpha}{2}\sqrt{\frac{\sigma_1^2}{n_1}+\frac{\sigma_2^2}{n_2}}=1-\alpha$\\
				...
				\center\normalsize Konfidensintervall for $\frac{\sigma_1^2}{\sigma_2^2}$\\
				{\footnotesize\raggedright
				...
				\center\normalsize Konfidensintervall for $p_1-p_2$\\
				{\footnotesize\raggedright
				...
				\center\normalsize Konfidensintervall for $\mu_D$\\
				{\footnotesize\raggedright
		...
		\begin{column}{.25\linewidth}
			...
			\begin{block}{\center\normalsize Fordelinger}
				\center\normalsize Binomisk fordeling\\
				{\footnotesize\raggedright
					\begin{enumerate}
						\item $n$ uavhengige delforsøk
						\item To utfall: suksess/ikke suksess
						\item Samme sannsynlighet for $p=P(a)$ (suksess) i alle delforsøk
					\end{enumerate}
				}
				\center\normalsize Hypergeometrisk fordeling\\
				{\footnotesize\raggedright
					\begin{enumerate}
				...
				\center\normalsize Eksponensialfordeling\\
				{\footnotesize\raggedright
