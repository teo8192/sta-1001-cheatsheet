			...
			\begin{block}{Løsningsforslag}
				...
				{\footnotesize\raggedright
					\textit{Ola samler spillekort.
						...
						Hva er forventa antall ulike spillekort i pakka?}\par
					Ola gjør $n=20$ kjøp.
					Resultatet av hvert kjøp er uavhengige, og sannsynligheten for suksess (kort $A$) er lik $\frac{1}{10}$ for hvert kjøp.
					Da blir $Y=$tal på kort $A$, binomisk fordelt med $n=20$ delforsøk og sannsynlighet $p=\frac{1}{10}$:\\
