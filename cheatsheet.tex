			...
			\begin{block}{Løningsforslag}
				...
				\oppgave{Vi anntar at konsentrasjonen i en prøve $Y_i$, av volum $l_i$ liter har følgende fordeling:
					...
					\maths{&\hat\mu=\frac{\sum_{i=1}^nl_iY_i}{\sum_{i=1}^nl_i},
						&\text{og}&
						&\hat\sigma^2=\frac{\sum_{i=1}^nl_i(Y_i-\hat\mu)^2}{n}}.}
				{\maths{L(\mu, \sigma^2)
					...
					\maths{
						\ln L&= -\frac{n}{2}\ln(2\pi)-\frac{n}{2}\ln(\sigma^2)-\frac{1}{2\sigma^2}\sum_{i=1}^nl_i(y_i-\mu)^2+\frac{1}{2}\ln\left(\sum_{i=1}^nl_i\right)&\\
